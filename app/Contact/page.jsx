    ...
    return (
        <Layout className="bg-[#F6EBDA]">
            <div className="flex flex-col items-center bg-[#F6EBDA] overflow-x-hidden">
                <h1 className="text-3xl lg:text-6xl text-white font-semibold items-center justify-center text-center w-full py-40"
                    style={{
                ...
                <section
                    ...
                    <div className="w-full h-full flex flex-wrap gap-32 items-center justify-center py-16">
                        <div
